                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    ...
                    <li>
                        <a
                            ...
                            target="_blank"
                            class="inline-block rounded-sm border border-[#e3e3e0] bg-white px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1b1b18] dark:border-[#3E3E3A] dark:bg-[#161615] dark:text-[#EDEDEC] dark:hover:border-[#eeeeec]"
                        >
                            Deploy now
                        </a>
                    </li>
